const MENU = {
  ...
  lemonade: {
    ...
    items: [
      {id:'mojito', img:'img/mojito.png', name:{ru:'Mojito Classic',kz:'Mojito Classic'}, desc:{ru:'Классический освежающий мохито',kz:'Классикалық сергітетін мохито'}, sizes:{500:1500}, temp:'cold', emoji:'🍃', color:'#c4ecb4'},
