const MENU = {
  tea_cream: {
    ...
    items: [
      {id:'lychee_cream', img:'img/lychee_cream.jpg', name:{ru:'Lychee Cream',kz:'Lychee Cream'}, desc:{ru:'Личи, жасмин, сырная шапка, классическое желе, тапиока',kz:'Личи, жасмин, ірімшік қалпақ, классикалық желе, тапиока'}, sizes:{500:1750,700:1990}, temp:'cold', emoji:'🥤', color:'#ffb8d9'},
  ...
  lemonade: {
    ...
    items: [
      ...
      {id:'granat', img:'img/granat.jpg', name:{ru:'Гранатовый удар',kz:'Гранатовый удар'}, desc:{ru:'Насыщенный гранатовый вкус',kz:'Анар дәмі бар қанық лимонад'}, sizes:{500:1500}, temp:'cold', emoji:'🔴', color:'#ff9fb0'},
      {id:'kivi_mar', img:'img/kivi_mar.jpg', name:{ru:'Киви Маракуйя',kz:'Киви Маракуйя'}, desc:{ru:'Киви и маракуйя',kz:'Киви мен маракуйя'}, sizes:{500:1500}, temp:'cold', emoji:'🥝', color:'#c4ecb4'},
      {id:'mango_mar', img:'img/mango_mar.jpg', name:{ru:'Манго Маракуйя',kz:'Манго Маракуйя'}, desc:{ru:'Манго и маракуйя',kz:'Манго мен маракуйя'}, sizes:{500:1500}, temp:'cold', emoji:'🥭', color:'#ffd28a'},
      {id:'cherry_moj', img:'img/cherry_moj.jpg', name:{ru:'Cherry Мохито',kz:'Cherry Мохито'}, desc:{ru:'Вишнёвый мохито',kz:'Шие мохито'}, sizes:{500:1500}, temp:'cold', emoji:'🍒', color:'#ff7a7a'},
      {id:'ananas_moj', img:'img/ananas_moj.jpg', name:{ru:'Ананас Мохито',kz:'Ананас Мохито'}, desc:{ru:'Ананасовый мохито',kz:'Ананас мохито'}, sizes:{500:1500}, temp:'cold', emoji:'🍍', color:'#ffe08a'},
      {id:'malina_moj', img:'img/malina_moj.jpg', name:{ru:'Малина Мохито',kz:'Малина Мохито'}, desc:{ru:'Малиновый мохито',kz:'Таңқурай мохито'}, sizes:{500:1500}, temp:'cold', emoji:'🫐', color:'#ff9fb0'},
    ]
  },
  special: {
    ...
    items: [
      ...
      {id:'snickers', img:'img/snickers.jpg', name:{ru:'Snickers',kz:'Snickers'}, desc:{ru:'Карамель, шоколад, лесные орехи, молоко, тапиока',kz:'Карамель, шоколад, фундук, сүт, тапиока'}, sizes:{500:1850,700:2050}, temp:'cold', emoji:'🍫', color:'#a07050'},
      {id:'oreo', img:'img/oreo.jpg', name:{ru:'Oreo',kz:'Oreo'}, desc:{ru:'Oreo, молоко, шоколад, сырная шапка, тапиока',kz:'Oreo, сүт, шоколад, ірімшік көбігі, тапиока'}, sizes:{500:1850,700:2050}, temp:'cold', emoji:'🖤', color:'#3a2a2a'},
  ...
  fruits: {
    ...
    items: [
      ...
      {id:'lime_extra', img:'img/lime_extra.jpg', name:{ru:'Lime Extra',kz:'Lime Extra'}, desc:{ru:'Лайм, лимон, листья мяты, жасмин, кокосовое желе',kz:'Лайм, лимон, жалбыз, жасмин, кокос желесі'}, sizes:{500:1550,700:1700}, temp:'cold', emoji:'🍋', color:'#c4ecb4'},
  ...
  desserts: {
    ...
    items: [
      {id:'mochi', img:'img/mochi.jpg', name:{ru:'Моти',kz:'Моти'}, desc:{ru:'Ассортимент: киви, малина, вишня, банан, лесные ягоды, нутелла, орео',kz:'Ассортимент: киви, таңқурай, шие, банан, жабайы жидектер, нутелла, орео'}, sizes:{'шт':1200}, temp:'cold', emoji:'🍡', color:'#ffd6ea'},
    ]
  }
};
