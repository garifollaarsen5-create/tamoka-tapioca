...
const I18N = {
  ru: {
    ...
    about_p1:'Десятки авторских вкусов — от классической тапиоки до летних лимонадов и нежных тиа-кримов.',
  ...
  kz: {
    ...
    about_p1:'Классикалық тапиокадан бастап жазғы лимонадтар мен жұмсақ tea-cream дәмдерге дейін ондаған таңдау.',
