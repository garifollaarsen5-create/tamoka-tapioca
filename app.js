...
const I18N = {
  ru: {
    ...
    about_p1:'Десятки авторских вкусов — от классической тапиоки до летних лимонадов.',
  ...
  kz: {
    ...
    about_p1:'Классикалық тапиокадан бастап жазғы лимонадтарға дейін ондаған таңдау.',
